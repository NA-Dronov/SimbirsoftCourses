...
namespace HtmlCorrectorApp_BitArray
{
    public class HtmlCorrector
    {
        ...
        /// </summary>
        public BitArray status = new BitArray(3, false); // OutLoaded, InLoaded, DictLoaded flags
        //[Flags]
        ...
        private void ShowMenu()
        {
            ...
            if (status.Equals(new BitArray(3, true)))
            {
                Console.ForegroundColor = ConsoleColor.Green;
            }
